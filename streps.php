 ...
 <div class="content-wrapper">
    <div class="container">
      ...
      <section class="content-header">
        <h1 class="textarea">
            <!-- Ongoing Operations -->
          <small class="external-event bg-green ui-draggable ui-draggable-handle" >Sitreps</small>
        </h1>
        <ol class="breadcrumb hidden-xs">
          <li><a href="home.php"><i class="fa fa-dashboard"></i> Sitreps</a></li>
        </ol>
      </section>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#timeline" data-toggle="tab">My Sitreps</a></li>
              <li class="hidden-xs"><a href="#newStrips" data-toggle="tab">New Sitrep</a></li>
				...
				$query = $database->query($sql);
			     ...
			     <div class="post">
                  ...
                  <ul class="list-inline">
                    ...
                    <li><a href="#" class="link-black text-sm"><b style="color:red;">'.$postdata['category'].' Sitrep</b></a></li> 
                    ';
                        ...
                        <div class="row" style="margin-top: 15px">
                          <div class="form-group">
                            <div class="col-md-12 col-sm-12">
                              ...
                              <textarea class="form-control" rows="4" name="oremark" id="0_remark" ></textarea>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row" style="margin-top: 15px">
                          <div class="form-group">
                            <div class="col-md-12 col-sm-12">
                              ...
                              <textarea class="form-control" rows="3" name="s_remark" id="s_remark" ></textarea>
                            </div>
                          </div>
                        </div> 
